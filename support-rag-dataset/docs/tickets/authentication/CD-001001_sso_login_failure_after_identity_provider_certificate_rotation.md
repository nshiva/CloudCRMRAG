...
title: "SSO login failure after identity provider certificate rotation - customer case 1"
...
resolved_at: 2024-12-12
tags: ["authentication", "resolved", "ki-001"]
related_ids: ["KI-001", "TG-AUTH-SSO-001"]
---

# Ticket CD-001001: SSO login failure after identity provider certificate rotation

## Customer
Atlas Learning

## Customer Message
We are seeing this issue: Invalid SAML response error.
