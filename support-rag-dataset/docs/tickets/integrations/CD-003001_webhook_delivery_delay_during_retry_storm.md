...
module: Integrations
title: "Webhook delivery delay during retry storm - customer case 1"
...
# Ticket CD-003001: Webhook delivery delay during retry storm

## Customer
Riverstone Analytics

## Customer Message
Can you check why third-party integration receives duplicate retries for our workspace?
