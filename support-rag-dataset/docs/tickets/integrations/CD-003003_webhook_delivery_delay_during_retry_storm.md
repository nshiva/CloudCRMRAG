...
module: Integrations
title: "Webhook delivery delay during retry storm - customer case 3"
...
# Ticket CD-003003: Webhook delivery delay during retry storm

## Customer
Atlas Learning

## Customer Message
Our team says webhook events arrive late and it is blocking daily work.
