...
module: Reporting
title: "Dashboard revenue numbers mismatch exported report - customer case 2"
...
# Ticket CD-005002: Dashboard revenue numbers mismatch exported report

## Customer
Evergreen Retail

## Customer Message
We are seeing this issue: Saved dashboard and exported report show different totals.
