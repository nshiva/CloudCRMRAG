...
module: Performance
title: "API requests fail due to rate limit confusion - customer case 2"
...
resolved_at: 2025-04-12
tags: ["performance", "resolved", "ki-010"]
related_ids: ["KI-010", "TG-API-RATE-010"]
---

# Ticket CD-010002: API requests fail due to rate limit confusion
